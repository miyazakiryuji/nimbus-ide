...
- [ ] T-114 コミットの意味単位への分割 — 作業ツリーの変更を意図ごとに束ね、`git add -- …` まで出す。
      実装前に claim @session-b 2026-08-13 [P2]

- [ ] T-232 サブエージェントごとのモデル指定。実装前に claim @session-a 2026-08-13 [P2]

- [ ] T-154 圧縮前に何を残すかを選ぶ画面。実装前に claim @session-a 2026-08-13 [P2]
