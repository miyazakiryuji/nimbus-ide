...
- 🔒 @session-i | T-364/T-365 | 2026-08-31 14:55 | extensions/nimbus/src/core/checkpoints.ts, extensions/nimbus/src/extension.ts, extensions/nimbus/src/test/checkpoints.test.ts

- 🔒 @session-i | T-361 | 2026-08-31 14:38 | src/vs/workbench/browser/layout.ts, src/vs/workbench/browser/parts/sidebar/sidebarPart.ts, nimbus/branding/apply-core-changes.mjs, nimbus/docs/core-changes.md
- 🔒 @session-i | T-362 | 2026-08-31 14:38 | extensions/nimbus/media/cockpit.css, nimbus/docs/specs/cockpit-home.md
...
- [ ] T-364 **巻き戻しが「会話だけが戻ります」と言うが、会話は戻っていない** — Codex の指摘
...
- [ ] T-365 **巻き戻しに失敗しても「戻しました」と通知する** — Codex の指摘 2026-08-31・裏取り済み。
...
- [ ] T-361 **サイドバーの幅を、ビューごとに覚える** — 利用者報告 2026-08-31
...
- [ ] T-362 **セッションの列と会話、セッション同士に区切り線を入れる** — 利用者報告 2026-08-31
