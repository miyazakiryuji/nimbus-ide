...
- 🔒 @session-i | T-368/T-369 | 2026-09-01 09:00 | extensions/nimbus/src/extension.ts, extensions/nimbus/src/sessionStore.ts, nimbus/tests/gui/run.mjs, nimbus/tests/gui/cases/69-*.mjs
...
- [ ] T-368 **閉じて開き直すと、開いていたセッションが全部消える** — 利用者報告 2026-09-01。
      ...
      **原因は 2 つ**（実機の台帳を読んで確定）:
      ...
      次: 固めた `.app` でケース 69 を走らせ、①が実機で効くことを確かめる
- [ ] T-369 **アプリを閉じて開き直す経路が、テストで一度も通っていない** — 同日に判明した**確認の穴**。
      ...
      **再起動をまたぐ振る舞い（台帳・タブの復元・覚えた幅）が丸ごと未検査**。
      ...
      残: Codex の穴の棚卸しを受けて、再起動をまたぐ他の経路（覚えた幅・ピン・束）も足す
